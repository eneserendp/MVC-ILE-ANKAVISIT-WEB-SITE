...
namespace TravelTripProje.Controllers
{
    public class AdminController : Controller
    {
        ...
        [HttpGet]
        public ActionResult HakkimizdaBlog()
        {
            return View();

        }
        [HttpPost]
        public ActionResult HakkimizdaBlog(Hakkimizda p)
        {
            c.Hakkimizdas.Add(p);
            c.SaveChanges();
            return RedirectToAction("Index");
        ...
        {
            var hkmz = c.Hakkimizdas.Find(p.Id);
            hkmz.FotoUrl = p.FotoUrl;
            hkmz.Aciklama = p.Aciklama;
